...
namespace BP3D.Items {
  ...
  export abstract class WallItem extends Item {
    ...
    constructor(model: Model.Model, metadata: Metadata, geometry: THREE.Geometry, material: THREE.Material[], position: THREE.Vector3, rotation: number, scale: THREE.Vector3) {
